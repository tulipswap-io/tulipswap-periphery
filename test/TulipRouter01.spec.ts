...
enum RouterVersion {
  TulipRouter01 = 'TulipRouter01',
  TulipRouter02 = 'TulipRouter02'
}

describe('TulipRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.TulipRouter01]: fixture.router01,
        [RouterVersion.TulipRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.TulipRouter01]: 101756,
              [RouterVersion.TulipRouter02]: 101778
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.TulipRouter01]: 138656,
              [RouterVersion.TulipRouter02]: 138656
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
